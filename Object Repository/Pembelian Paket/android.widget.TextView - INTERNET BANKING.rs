...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - INTERNET BANKING</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'INTERNET BANKING' or . = 'INTERNET BANKING')]</locator>
