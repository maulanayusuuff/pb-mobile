...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - ATM MANDIRI</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'ATM MANDIRI' or . = 'ATM MANDIRI')]</locator>
