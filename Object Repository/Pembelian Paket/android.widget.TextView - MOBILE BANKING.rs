...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - MOBILE BANKING</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'MOBILE BANKING' or . = 'MOBILE BANKING')]</locator>
