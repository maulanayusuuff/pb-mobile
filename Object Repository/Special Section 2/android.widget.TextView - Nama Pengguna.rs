...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Nama Pengguna</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Nama Pengguna' or . = 'Nama Pengguna')]</locator>
