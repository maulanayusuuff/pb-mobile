...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Rahasia Pribadi</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Rahasia Pribadi' or . = 'Rahasia Pribadi')]</locator>
