...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Matematika</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Matematika' or . = 'Matematika')]</locator>
