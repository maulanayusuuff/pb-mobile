...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Selesai Review</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Selesai Review' or . = 'Selesai Review')]</locator>
