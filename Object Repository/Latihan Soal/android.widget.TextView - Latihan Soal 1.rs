...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Latihan Soal 1</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Latihan Soal 1' or . = 'Latihan Soal 1')]</locator>
