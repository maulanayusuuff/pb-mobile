...
<MobileElementEntity>
   ...
   <name>android.widget.Image - bottom-fade</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'bottom-fade' or . = 'bottom-fade') and @resource-id = 'img_fade']</locator>
