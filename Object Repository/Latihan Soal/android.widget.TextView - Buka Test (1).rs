...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Buka Test (1)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Buka Test' or . = 'Buka Test')]</locator>
