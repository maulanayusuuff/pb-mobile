...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Back LMS</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'keyboard_backspace' or . = 'keyboard_backspace')]</locator>
