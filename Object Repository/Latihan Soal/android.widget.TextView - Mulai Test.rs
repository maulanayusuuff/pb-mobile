...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Mulai Test</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Mulai Test' or . = 'Mulai Test')]</locator>
